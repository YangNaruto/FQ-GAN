...
if 1:
    ...
    D             = EasyDict(func_name='training.networks_stylegan.D_basic_quant')               # Options for discriminator network.
    ...
    # Dataset.
    desc += '-ffhq';    dataset = EasyDict(
        tfrecord_dir='ffhq', resolution=64); train.mirror_augment = True
    ...
    sched.G_lrate_dict = {16:0.0010, 32: 0.0010, 64: 0.0012, 128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.003}
